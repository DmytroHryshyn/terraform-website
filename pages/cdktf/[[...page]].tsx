...
export default function CDKLayout(props) {
    ...
    return (<DocsPage baseRoute={BASE_ROUTE} product={PRODUCT} projectName={PROJECT_NAME} staticProps={modifiedProps} showVersionSelect/>);
}
    ...
    ? {
        ...
        remarkPlugins: (params) => [
            ...
            remarkRewriteAssets({
                ...
                getAssetPathParts: (nodeUrl) => Array.isArray(params.page)
                    ? [
                        'website/docs/cdktf',
                        ...params.page,
